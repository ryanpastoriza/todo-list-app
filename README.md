...
### Server Deployment (Example: Render/Railway)
...
### Client Deployment (Example: Vercel/Netlify)
...
### Main Interface
![Todo List Main](./screenshots/main.png)

### Filter Views
![Filter Views](./screenshots/filters.png)
